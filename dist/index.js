...
const parse = (files) => __awaiter(void 0, void 0, void 0, function* () {
    var e_1, _a;
    ...
    try {
        for (var _b = __asyncValues(globber.globGenerator()), _c; _c = yield _b.next(), !_c.done;) {
            ...
            result = Object.assign(Object.assign({}, result), dotenv_1.default.parse(content));
        }
    }
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const env_obj = yield (0, exports.parse)(files);
